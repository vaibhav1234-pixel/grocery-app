<template >
    <div>
        <!-- Modal -->
        <div class="modal fade" id="addsubcatrequest" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
            data-bs-backdrop="static" data-bs-keyboard="false">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Request New Sub-Category</h5>
                    </div>
                    <div class="modal-body">
                        <div v-if="successSubcat" class="alert alert-success">
                            {{ successSubcat }}
                        </div>
                        <div v-else>
                            ...
                            <form ref="addSubcatRequestForm" class="needs-validation" novalidate>
                                <div class="mb-3">
                    ...
                    <div v-if="!(successSubcat)">
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                            <button type="submit" class="btn btn-primary" @click="addSubcat">
                                Add </button>
...
export default {
    ...
    methods: {
        ...
        addSubcat() {
            const form = this.$refs.addSubcatRequestForm;
            ...
            if (form.checkValidity()) {
                ...
                axios.post("http://127.0.0.1:5000/subcatcreate/manager", formData, {
                    ...
                    .then((response) => {
                        ...
                        const successSubcat = response.data.success

                        // Update flashed messages
                        this.flashMessages = messages;
                        this.successSubcat = successSubcat
