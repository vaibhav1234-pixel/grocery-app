<template >
    <div>
        <!-- Modal -->
        <div class="modal fade" id="editsubcatrequest" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div v-else>
                            ...
                            <form ref="editSubcatRequestForm" class="needs-validation" novalidate>
                                <div class="mb-3">
...
export default {
    ...
    methods: {
        ...
        editSubcat() {
            const form = this.$refs.editSubcatRequestForm;
            ...
            if (form.checkValidity()) {
                ...
                axios.post("http://127.0.0.1:5000/subcatedit/manager/" + this.subcat_id, formData, {
