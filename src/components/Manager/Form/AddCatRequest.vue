<template >
    <div>
        <!-- Modal -->
        <div class="modal fade" id="addcatrequest" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
            data-bs-backdrop="static" data-bs-keyboard="false">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Request New Category</h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div v-else>
                            ...
                            <form ref="addCatRequestForm" class="needs-validation" novalidate>
...
export default {
    ...
    methods: {
        ...
        addCat() {
            const form = this.$refs.addCatRequestForm;
            ...
            if (form.checkValidity()) {
                ...
                axios.post("http://127.0.0.1:5000/catcreate/manager", formData, {
