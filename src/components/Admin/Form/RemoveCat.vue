<template >
    <div>
        <!-- Modal -->
        <div class="modal fade" id="removecat" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div v-else>
                            ...
                            <form ref="catRemoveForm" class="needs-validation" novalidate>
                                <div class="mb-3">
...
export default {
    ...
    methods: {
        ...
        removeCat() {
            const form = this.$refs.catRemoveForm;

            if (form.checkValidity()) {


                // Make a POST request to your Flask backend
                axios.delete("http://127.0.0.1:5000/catremove/admin/" + this.cat_id, {
