<template >
    <div>
        <!-- Modal -->
        <div class="modal fade" id="removesubcat" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    ...
    methods: {
        ...
        removeSubcat() {
            ...
            if (form.checkValidity()) {
                ...
                axios.delete("http://127.0.0.1:5000/subcatremove/admin/" + this.subcat_id, {
