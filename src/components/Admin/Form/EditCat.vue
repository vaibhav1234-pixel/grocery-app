                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div v-else>
                            ...
                            <form ref="editcatForm" class="needs-validation" novalidate>
                                <div class="mb-3">
                    ...
                    <div v-if="!(cateditsuccess)">
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" @click="editCat">
                                Edit </button>
...
export default {
    ...
    methods: {
        ...
        editCat() {
            const form = this.$refs.editcatForm;
            ...
            if (form.checkValidity()) {
                ...
                axios.post("http://127.0.0.1:5000/catedit/admin/" + this.cat_id, formData, {
